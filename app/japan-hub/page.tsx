    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="font-serif text-3xl md:text-4xl text-foreground">
              Tu Planificación de Viaje y Beneficios VIP
            </h2>
            <p className="text-foreground/70 max-w-2xl mx-auto text-lg font-light">
              Nos encargamos de la logística para que te enfoques en la
              experiencia.
            </p>
          </div>
          <motion.div
          ...
          >
            {[
              {
                icon: FileText,
                title: "Itinerario PDF Diario",
                desc: "Se entrega 1 mes antes. Síguelo al pie de la letra o ve a tu ritmo.",
              },
              {
                icon: Video,
                title: "Llamada de Bienvenida",
                desc: "Asesoría 1-a-1 por Zoom/WhatsApp para apps como Suica, VisitJapan y tips.",
              },
              {
                icon: Headphones,
                title: "Soporte Dedicado 24/7",
                desc: "Asistencia antes, durante y después de todo tu viaje.",
              },
              {
                icon: MapPin,
                title: "Guías de Atracciones",
                desc: "PDFs con consejos de expertos y rutas óptimas para Disney y Universal.",
              },
            ].map((feature, i) => (
              <motion.div
                key={i}
                variants={fadeInUp}
                className="bg-background/60 backdrop-blur-md rounded-2xl p-6 border border-border/50 shadow-sm hover:shadow-md transition-shadow"
              >
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="font-serif text-4xl text-foreground">
              Tus Hospedajes Prémium
            </h2>
            <p className="text-foreground/70 max-w-2xl mx-auto text-lg font-light">
              Estancias de lujo con estándar asiático ubicadas en el corazón de
              Tokio y Osaka.
            </p>
          </div>
            ...
            {[
              ...
              <Card key={i} className="overflow-hidden border-border/50">
                ...
                <CardContent className="p-8">
                  <CardTitle className="mb-4 text-2xl font-serif text-primary">
                    {hotel.title}
                  </CardTitle>
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4">
            <h2 className="font-serif text-4xl text-foreground">
              Experiencias Curadas y Tránsito Prémium
            </h2>
            <p className="text-foreground/70 max-w-2xl mx-auto text-lg font-light">
              Todas las entradas y boletos de tren bala entre ciudades están
              incluidos.
            </p>
          </div>
            ...
            {[
              {
                ...
                info: "Experiencia en tren bala Tokio ⇆ Osaka incluida.",
                image:
              ...
              },
              {
                ...
                info: "Entrada estándar incluida.",
                image:
              ...
              },
              {
                ...
                info: "Vistas espectaculares desde el rooftop incluidas.",
                image:
              ...
              },
              {
                ...
                info: "Entrada al arte inmersivo incluida.",
      ...
      <section className="py-32 px-6 flex flex-col items-center justify-center text-center bg-primary/5 min-h-screen">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-serif text-3xl md:text-5xl mb-6">
            ¿Listo para hacer realidad tu sueño japonés?
          </h2>
          <p className="text-foreground/70 text-lg mb-10 font-light">
            Agenda una llamada de descubrimiento completamente gratuita con
            nuestro equipo.
          </p>
          <Button
            size="lg"
